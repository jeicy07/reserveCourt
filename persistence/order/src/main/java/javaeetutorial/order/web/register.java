...
public class register extends HttpServlet {
    ...
    private class regResp {

        public regResp(boolean status) {
            this.status = status;
        }
	...
	response.addHeader("Access-Control-Allow-Origin","*");	
        ...
        try {
            ...
            boolean finalStatus = requestb.register(username, password, name, phone);

            Gson gson = new Gson();
            register.regResp respData = new register.regResp(finalStatus);
