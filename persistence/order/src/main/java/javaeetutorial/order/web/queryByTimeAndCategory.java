 ...
 * @author jicl
 */
public class queryByTimeAndCategory extends HttpServlet {
    ...
    private class queryByTimeAndCateResp {
        
        public queryByTimeAndCateResp(List<Integer> availableCourtIds) {
	...
	response.addHeader("Access-Control-Allow-Origin","*");	
        ...
        try {
            ...
            //connect database
            List<Integer> results = requestb.queryByTimeAndCategory(year, month,
                                date, startHour, category);

            Gson gson = new Gson();
            queryByTimeAndCategory.queryByTimeAndCateResp respData = 
                    new queryByTimeAndCategory.queryByTimeAndCateResp(results);
